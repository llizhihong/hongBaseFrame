...
public class SwipeBackLayout extends FrameLayout {
     ...
     * callback's
     * {@link com.hong.hongbaseframe.view.swipeback.ViewDragHelper.Callback#onEdgeTouched(int, int)}
     * and
     * {@link com.hong.hongbaseframe.view.swipeback.ViewDragHelper.Callback#onEdgeDragStarted(int, int)}
