...
/**
 * 作者：李智宏 on 2016/5/30 17:10
 * 描述：验证身份证号码 身份证号码, 可以解析身份证号码的各个字段，
 * 以及验证身份证号码是否有效; 身份证号码构成：6位地址编码+8位生日+3位顺序码+1位校验码
 */
public class CheckIdCard {

    private String cardNumber; // 完整的身份证号码
    private Boolean idCradValidateResult; // 缓存身份证是否有效，因为验证有效性使用频繁且计算复杂
    ...
    public boolean validate() {
        ...
        idCradValidateResult = result;
        return idCradValidateResult;
    }
